...
// =======================================================================
{
  ...
  s.addText(
    "Independent analysis, not affiliated with or endorsed by FedEx. Built entirely on public information — "
    + "no proprietary, confidential, or internal FedEx data was used.",
    { x: 0.9, y: 6.85, w: 9.5, h: 0.45, fontFace: FONT, fontSize: 9.5, italic: true, color: "8F84A8", lineSpacing: 13 }
  );
}
...
// =======================================================================
{
  ...
  const rows = [
    ...
    ["barchart", "The method: Detect → Target → Forecast", "A full Python pipeline (pandas, scikit-learn) — shipment-level leakage detection, composite account risk scoring, and a fitted trend forecast with a modeled intervention ramp."],

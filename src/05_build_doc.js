  ...
  sections: [
    ...
    // =====================================================================
    {
      ...
      children: [
        ...
        bullet("The method — Detect, Target, Forecast — is fully demonstrated end to end: shipment-level leakage detection, composite account risk scoring, and regression-based forecasting, all built and run in this proof-of-concept."),
